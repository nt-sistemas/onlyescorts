<div class="flex flex-col items-center justify-center w-full">
    <x-card shadow class="w-full p-4 m-2 mt-8 shadow-lg bg-white/50 lg:w-1/3 lg:h-3/4 rounded-bl-3xl rounded-tr-3xl">
        <div class="flex flex-col items-center gap-4 m-4">
            ...
            <span class="w-2/3 text-sm italic text-center text-primary">Your information such as name and date of birth
                must match the document</span>
        </div>
        ...
        <x-form wire:submit="save">
            ...
            <x-file wire:model="file" label="Send document file" />
